...
//        self.navigationController?.isNavigationBarHidden=true
        ...
        startButton.addTarget(self, action: #selector(clickStartButton), for: UIControlEvents.touchUpInside)
        ...
        endButton.addTarget(self, action: #selector(clickEndButton), for: UIControlEvents.touchUpInside)
        ...
        resetButton.addTarget(self, action: #selector(clickResetButton), for: UIControlEvents.touchUpInside)
